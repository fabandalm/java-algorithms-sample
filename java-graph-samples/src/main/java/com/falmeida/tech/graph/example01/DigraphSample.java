...
public class DigraphSample {
	...
	public DigraphSample(List<Edge> edges)
	{
	...
	private static void printGraph(DigraphSample graph)
	{
		int src = 0;
	...
	public static void main (String[] args){
		...
		DigraphSample graph = new DigraphSample(edges);
