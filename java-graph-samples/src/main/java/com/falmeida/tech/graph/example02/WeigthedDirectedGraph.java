package com.falmeida.tech.graph.example02;
...
class WeigthedDirectedGraph
{
	...
	public WeigthedDirectedGraph(List<Edge> edges)
	{
	...
	private static void printGraph(WeigthedDirectedGraph graph)
	{
		int src = 0;
	...
	public static void main (String[] args)
	{
		...
		WeigthedDirectedGraph graph = new WeigthedDirectedGraph(edges);
